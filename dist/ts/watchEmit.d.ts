...
export type WatchEmitType<E extends EventBase> = <T extends keyof E, U extends keyof E, V extends keyof E>(signal: T, payload: Omit<E[T], 'rayId'>, success: U, failure: V) => Promise<E[U]>;
